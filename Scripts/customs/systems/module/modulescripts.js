...
function p_DataToUI(objData) {
    $("#txtID").val(clsGlobal.parseToInteger(objData.INT_MODULE_ID));
    $("#txtModuleName").val(clsGlobal.parseToString(objData.TXT_MODULENAME));
...
function p_initiateData() {
    ...
    $.ajax({
        ...
        data: { __RequestVerificationToken: $('#frmModule input[name=__RequestVerificationToken]').val() },
        datatype: "json",
...
function p_UIToData() {
    ...
    jsonData.INT_MODULE_ID = clsGlobal.parseToInteger($("#txtID").val());
    jsonData.TXT_MODULENAME = $("#txtModuleName").val().toString();
...
function p_txtID_TextChanged() {
    ...
    $.ajax({
        ...
        data: { txtID: $("#txtID").val(), __RequestVerificationToken: $('#frmModule input[name=__RequestVerificationToken]').val() },
        datatype: "json",
        success: function (retDat) {

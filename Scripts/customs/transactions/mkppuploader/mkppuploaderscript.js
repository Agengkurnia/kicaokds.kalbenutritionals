...
function p_initiateData() {
    ...
    $.ajax({
        type: "POST",
        url: "/Transaction/MKPPUploader/InitiateData",
...
function p_txtDocNo_TextChanged(ID) {
    ...
    $.ajax({
        type: "POST",
        url: "/Transaction/MKPPUploader/GetData", 
...
function p_processData() { 
    ...
    $.ajax({
        type: "POST",
        url: "/Transaction/MKPPUploader/ProcessData",
...
function p_Upload() {
    clsGlobal.getConfirmation("UploadMKPP?", function (result) {
        if (result == true) {
            ...
            $.ajax({
                type: "POST",
                url: "/Transaction/MKPPUploader/Upload",
                processData: false,
                contentType: false,
                data: data,
                success: function (retDat) {
...
function p_Download() {
    clsGlobal.getConfirmation("Download Template UploadMKPP?", function (result) {
        if (result == true) {
            clsGlobal.showLoading();
            $.ajax({
                type: "POST",
                url: "/Transaction/MKPPUploader/Download",
...
function p_DownloadResult() {
    clsGlobal.getConfirmation("Download Result?", function (result) {
        if (result == true) {
            ...
            $.ajax({
                type: "POST",
                url: "/Transaction/MKPPUploader/DownloadResult",
                data: { data: $("#txtHiddenObject").val(), txtGUID: $("#txtGUID").val(), __RequestVerificationToken: $('#frmIndexUploader input[name=__RequestVerificationToken]').val() },
                datatype: "json",
                success: function (url) {
                    window.location = url;
